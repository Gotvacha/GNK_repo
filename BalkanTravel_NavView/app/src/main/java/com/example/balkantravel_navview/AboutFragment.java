package com.example.balkantravel_navview;
...
public class AboutFragment extends FragmentActivity implements OnMapReadyCallback {
...
//                    mapfrg.getMapAsync(AboutFragment.this);
                }
            }
        });
    }
